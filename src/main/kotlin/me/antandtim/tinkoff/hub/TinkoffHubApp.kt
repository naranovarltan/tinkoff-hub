...
import me.antandtim.tinkoff.hub.config.ApplicationProperties
...
class TinkoffHubApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes tinkoffHub.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<TinkoffHubApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(TinkoffHubApp::class.java)
