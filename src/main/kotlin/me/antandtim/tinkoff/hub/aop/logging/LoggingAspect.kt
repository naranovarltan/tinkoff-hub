package me.antandtim.tinkoff.hub.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(me.antandtim.tinkoff.hub.repository..*)" +
            " || within(me.antandtim.tinkoff.hub.service..*)" +
            " || within(me.antandtim.tinkoff.hub.web.rest..*)"
    )
